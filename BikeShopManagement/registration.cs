...
namespace BikeShopManagement
{
    public partial class Registration : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // Admin password check (consider using a secure method)
            if (adminPassword != "admin") // Replace with a more secure method in production
            {
            ...
            using (SqlConnection conn = koneksyon.GetConnection())
            {
                try
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@password", password); // Hash the password
                ...
                // No need for finally here as 'using' ensures connection is closed
            }
        }
