    ...
    public partial class dashboard : UserControl
    {
        ...
        private void LoadTotalInventory()
        {
            try
            {
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    int totalInventory = (int)command.ExecuteScalar();
        ...
        private void LoadInventoryValue()
        {
            try
            {
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    decimal inventoryValue = (decimal)command.ExecuteScalar();
        ...
        private void LoadTotalProfit(DateTime? startDate = null, DateTime? endDate = null)
        {
            try
            {
                connection.Open();
        ...
        private void LoadTotalCost(DateTime? startDate = null, DateTime? endDate = null)
        {
            try
            {
                connection.Open();
